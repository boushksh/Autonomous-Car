...
sub1 = rospy.Subscriber('/gazebo/model_states', ModelStates, callback_Act_St)
...
while 1 and not rospy.is_shutdown():
    ...
    if flag_St == 1 and flag_Lat == 1:
        ...
        Angles_Act = quaternion_to_euler(Actual_position.orientation.x, Actual_position.orientation.y,
